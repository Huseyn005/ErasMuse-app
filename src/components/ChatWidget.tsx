    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <ChatHeader isLive={isLive} onClose={onClose} />
            <ChatBody
              messages={messages}
              loading={loading}
...
function ChatHeader({ isLive, onClose }: { isLive: boolean; onClose: () => void }) {
  return (
    <div className="flex items-center justify-between px-4 py-3 bg-primary text-primary-foreground shrink-0">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold">ERASMuse Assistant</span>
        </div>
      </div>
      <div className="flex items-center gap-2">
        <span className={cn(
        ...
        <span className="text-xs text-white/70">{isLive ? "Live" : "Demo"}</span>
        <button
          onClick={onClose}
        ...
        <div className="space-y-4">
          <div className="text-center py-6">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Ask about transport, documents, events, or life in Ruse.
            </p>
          </div>
