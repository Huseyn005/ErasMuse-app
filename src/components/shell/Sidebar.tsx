                            ...
                            <TooltipTrigger asChild>
                                <NavLink to={to} end={to === '/'}>
                                    {({ isActive }) => (
                                        <span
                                            className={cn(
                                                'flex items-center rounded-xl transition-all duration-500 ease-in-out',
                                                isCollapsed
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <button
                                ...
                                className={cn(
                                    'w-full flex items-center gap-3 h-12 rounded-xl transition-all duration-500 ease-in-out text-muted-foreground hover:text-primary hover:bg-sidebar-accent',
